...
class Attention_Layer_3D(nn.Module):
    def __init__(self,feature_size,global_size,inter_channel):
        ...
        self.feature_size = feature_size # 1,channel,x,y,z
        self.global_size = global_size   # 1,channel,x,y,z
    ...
    def forward(self, feature_tensor, global_tensor):
        ...
        expanded_alpha = alpha.expand(feature_tensor.size())
        #expanded_alpha = normalized_alpha.expand(feature_tensor.size())
        ...
        return alpha,gap_weighted_feature
